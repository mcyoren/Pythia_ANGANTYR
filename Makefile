...
main91 main113_pAu dd27_promt newGenHeAu1 newGenpp6GeV diquarks RHIC RHIC_CuAu_kstar RHIC_pp_kstar_hard_qcd RHIC_pp_kstar_soft_qcd: $(PYTHIA) $$@.cc
ifeq ($(ROOT_USE),true)
...
main92 maindiq seadi: $(PYTHIA) $$@.cc main92.so
